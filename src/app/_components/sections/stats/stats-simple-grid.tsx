          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-ai-title-regular sm:text-4xl">
                Achieve Your Zen of Productivity
              </h2>
              <p className="mt-4 text-lg leading-8 text-ai-subtext-regular">
                Experience ultimate focus and efficiency with Temple – your sanctuary for work and productivity.
              </p>
            </div>
            <dl className="mt-16 grid grid-cols-1 gap-8 text-center sm:grid-cols-2 lg:grid-cols-4">
              {stats.map((stat, index) => (
                <div key={stat.id} className="relative flex flex-col bg-ai-background-regular border-2 border-ai-title-regular rounded-md p-8">
