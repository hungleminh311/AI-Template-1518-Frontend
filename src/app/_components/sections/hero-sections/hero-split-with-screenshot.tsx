  ...
  return (
    <div className={`relative isolate overflow-hidden`}>
      <div className="lg:grid grid-cols-2">
        ...
        <div className="bg-ai-secondary/[.3] px-6 pb-24 pt-10 sm:pb-32 lg:px-8 lg:py-40">
          <div className="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32 shadow-neo-brutal">
